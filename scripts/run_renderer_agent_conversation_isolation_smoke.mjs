...
const smoke = path.join(process.cwd(), 'scripts', 'renderer_agent_conversation_isolation_smoke.cjs');
...
const args = needsVirtualDisplay ? ['-a', electronPath, '--no-sandbox', smoke] : [smoke];
