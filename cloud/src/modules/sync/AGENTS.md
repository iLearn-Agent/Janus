...
- Read `../../../../docs/database-evolution-policy.md` before changing PostgreSQL sync tables, Sync payloads, identity canonicalization, Workspace routing, capabilities, cursors, or conflict handling.
